...
interface
uses SyncObjs,Classes,RTLConsts,Windows;
type
   TFixedCriticalSection = class(TCriticalSection)
      private
         FDummy : array [0..95] of Byte;
      public
        function GetSection :PRTLCriticalSection;
   end;
...
{ TFixedThreadList class }
  ...
  public
    ...
    property Locker :TFixedCriticalSection read FLock;
  end;
...
function TFixedCriticalSection.GetSection: PRTLCriticalSection;
begin
  Result := @FSection;
end;
